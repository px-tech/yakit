...
const WebsocketFuzzer = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_3031_9116)">
            ...
            <path d="M12 6V14" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
...
const SubDomainCollection = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_3031_9175)">
            <path d="M11 5H17C18.1046 5 19 5.89543 19 7V7" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M6 16L10 16" stroke="#31343F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M3 11L22 11" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
...
const Report = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_3031_9207)">
            ...
            <path d="M6 8L14 8" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
...
const PlugExecutionResults = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_3031_9237)">
            ...
            <path d="M6 11L14 11" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <path d="M15.3333 17.1227L16.4444 18.2541L18.6666 15.9913" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </g>
    </svg>
...
const PortAssets = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_3031_7917)">
            ...
            <path d="M6 12V16" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M9 12V16" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M12 12V16" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M15 12V16" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M18 12V16" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </g>
    </svg>
...
const VulnerabilityRisk = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_3031_7890)">
            ...
            <path d="M12 6.375V7.5M12 9.75H12.0056M8.12134 12H15.8787C16.7406 12 17.2793 11.0625 16.8483 10.3125L12.9697 3.5625C12.5387 2.8125 11.4613 2.8125 11.0303 3.5625L7.15168 10.3125C6.72072 11.0625 7.25942 12 8.12134 12Z" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </g>
    </svg>
    ...
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_3031_9146)">
            ...
            <g mask="url(#mask2_3031_9146)">
                <path d="M11.6583 8.12427C11.879 8.04399 12.121 8.04399 12.3417 8.12427L20.4156 11.0602C21.2932 11.3794 21.2932 12.6206 20.4156 12.9398L12.3417 15.8757C12.121 15.956 11.879 15.956 11.6583 15.8757L3.58443 12.9398C2.70675 12.6206 2.70676 11.3794 3.58443 11.0602L11.6583 8.12427Z" stroke="#1890ff" strokeWidth="1.5" />
            </g>
...
const HTTPHistory = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_3031_8824)">
            ...
            <path d="M6 8L9 8" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M12 8L17 8" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <path d="M19 15V17L20.5 18.5" stroke="#1890ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </g>
    </svg>
