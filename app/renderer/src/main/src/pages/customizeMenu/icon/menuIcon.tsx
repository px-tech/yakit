    ...
    <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none'>
        ...
        <g mask='url(#mask0_2721_76421)'>
            <path
                ...
                fill='#31343F'
            />
            <path d='M1 12H23' stroke='var(--yakit-primary-color)' strokeWidth='1.5' strokeLinecap='round' />
        </g>
    </svg>
)
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7447)'>
            <path
                ...
                strokeWidth='1.5'
            />
            <path d='M12 21V7' stroke='var(--yakit-primary-color)' strokeWidth='1.5' strokeLinecap='round' />
            <path
                d='M15 6C15 4.34315 13.6569 3 12 3C10.3431 3 9 4.34315 9 6'
                stroke='var(--yakit-primary-color)'
                strokeWidth='1.5'
                strokeLinecap='round'
            />
            <path
...
const SpecialVulnerabilityDetection = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_3031_7833)'>
            ...
            />
            <circle cx='12' cy='12' r='3' stroke='var(--yakit-primary-color)' strokeWidth='1.5' />
        </g>
    </svg>
)
...
const BatchVulnerabilityDetection = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7504)'>
            ...
            <circle cx='8' cy='14' r='2' fill='white' stroke='var(--yakit-primary-color)' strokeWidth='1.5' />
            <circle cx='17' cy='15' r='1' fill='white' stroke='var(--yakit-primary-color)' strokeWidth='1.5' />
            <circle cx='19' cy='5' r='1' fill='white' stroke='var(--yakit-primary-color)' strokeWidth='1.5' />
        </g>
    </svg>
)
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask1_2812_7361)'>
            ...
            <path
                ...
                fill='var(--yakit-primary-color)'
            />
            <circle cx='15' cy='15' r='8' stroke='#31343F' strokeWidth='1.5' />
            <path d='M13 8V11C13 12.1046 12.1046 13 11 13H8' stroke='#31343F' strokeWidth='1.5' strokeLinecap='round' />
        </g>
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7637)'>
            ...
            <path
                ...
                strokeWidth='1.5'
            />
            <path d='M9 16V19' stroke='var(--yakit-primary-color)' strokeWidth='1.5' strokeLinecap='round' />
            <path d='M12 16V19' stroke='var(--yakit-primary-color)' strokeWidth='1.5' strokeLinecap='round' />
            <path d='M15 16V19' stroke='var(--yakit-primary-color)' strokeWidth='1.5' strokeLinecap='round' />
        </g>
    </svg>
)
...
const ReverseConnectionServer = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7666)'>
            ...
            <path d='M12 14V17' stroke='var(--yakit-primary-color)' strokeWidth='1.5' />
            <path
                d='M20 17V16C20 14.8954 19.1046 14 18 14H6C4.89543 14 4 14.8954 4 16V17'
                stroke='#31343F'
                strokeWidth='1.5'
            />
            <circle cx='17' cy='6' r='1' fill='var(--yakit-primary-color)' />
            <circle cx='17' cy='10' r='1' fill='var(--yakit-primary-color)' />
            <circle cx='4.5' cy='18.5' r='1.5' stroke='#31343F' strokeWidth='1.5' />
            <circle cx='12' cy='18.5' r='1.5' stroke='var(--yakit-primary-color)' strokeWidth='1.5' />
...
const DNSLog = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7697)'>
            ...
            <path d='M17 6.5H18' stroke='var(--yakit-primary-color)' strokeWidth='1.5' strokeLinecap='round' />
        </g>
    </svg>
)
...
const ICMPSizeLog = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7727)'>
            ...
            <path d='M8 13L8 10' stroke='var(--yakit-primary-color)' strokeWidth='1.5' strokeLinecap='round' />
            <path d='M12 13V8' stroke='var(--yakit-primary-color)' strokeWidth='1.5' strokeLinecap='round' />
            <path d='M16 13L16 6' stroke='var(--yakit-primary-color)' strokeWidth='1.5' strokeLinecap='round' />
        </g>
    </svg>
)
...
const TCPPortLog = () => (
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_2812_7755)'>
            ...
            <circle cx='20.6338' cy='6.5' r='1.5' fill='white' stroke='var(--yakit-primary-color)' strokeWidth='1.5' />
        </g>
    </svg>
)
    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <g mask='url(#mask0_166_5755)'>
            ...
            <path
                ...
                strokeLinecap='round'
            />
            <circle cx='17' cy='16' r='4' stroke='var(--yakit-primary-color)' strokeWidth='1.5' />
        </g>
    </svg>
)
